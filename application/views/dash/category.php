    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <?= permission_export('
          <a href="'.base_url('export/category').'" class="btn btn-sm btn-neutral">
...
<div class="container-fluid mt--6">
    ...
    <div class="col">
      <div class="card">
                ...
                <td class="text-right">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                      <?= permission_update('<a class="dropdown-item" href="#" data-toggle="modal" data-target="#updateModal" data-id="'.$value['id'].'" data-code="'.$value['code'].'" data-name="'.$value['name'].'" data-remark="'.$value['remark'].'">Update</a>');?>
        ...
        <?php $this->template->pagging(
          array(
            'page_total' => $page_total, 'page' => $page, 'url' => base_url('dash/category/')
          )
        );?>
      </div>
    </div>
  ...
  <?= permission_create('<div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="newModal" aria-hidden="true">
    <div class="modal-dialog modal- modal-dialog-centered" role="document">
      <div class="modal-content">
        <form method="POST" action="' . base_url('create/category') . '" enctype="multipart/form-data">
  ...
  <?= permission_update('<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModal" aria-hidden="true">
    <div class="modal-dialog modal- modal-dialog-centered" role="document">
      <div class="modal-content">
        <form method="POST" action="' . base_url('update/category') . '" enctype="multipart/form-data">
          <div class="modal-header">
  ...
  <?php permission_delete( $this->component->delete( base_url('Delete/category') ) );?>
