    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <?= permission_export('
          <a href="'.base_url('export/notice').'" class="btn btn-sm btn-neutral">
    ...
    <div class="col">
      <div class="card">
        ...
        <?php $this->template->pagging(
          array(
            'page_total' => $page_total, 'page' => $page, 'url' => base_url('dash/notice/')
          )
        );?>
      </div>
    </div>
  ...
  <?= permission_create('<div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="newModal" aria-hidden="true">
    <div class="modal-dialog modal- modal-dialog-centered" role="document">
      <div class="modal-content">
        <form method="POST" action="' . base_url('create/notice') . '" enctype="multipart/form-data">
          <div class="modal-header">
            <h6 class="modal-title" id="modal-title-default">Tambah Pengunguman</h6>
