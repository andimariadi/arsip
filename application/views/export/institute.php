...
$pdf->SetTitle('Laporan Instansi');
$pdf->SetSubject('Laporan Instansi');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData('assets/img/icons/bartim.jpg', 10, 'Laporan Instansi', "Alamat: Banyu landas RT. 01, Benua Lima, Kalimantan Tengah", array(0,0,0), array(0,0,0));
...
$pdf->Output( 'Laporan Instansi.pdf', 'I');
?>