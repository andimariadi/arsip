...
$pdf->SetTitle('Laporan Sub Kategori Surat');
$pdf->SetSubject('Laporan Sub Kategori Surat');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData('assets/img/icons/bartim.jpg', 10, 'Laporan Sub Kategori Surat', "Alamat: Banyu landas RT. 01, Benua Lima, Kalimantan Tengah", array(0,0,0), array(0,0,0));
...
<table border="1">
    ...
    foreach ($data_category as $value) : 
        $html .= '<tr>
            <th scope="row">' . $value['category_description'] . '</th>
            <td>' . $value['code'] . '</td>
            <td>' . $value['name'] . '</td>
            <td>' . $value['remark'] . '</td>
        </tr>';
...
$pdf->Output( 'Laporan Sub Kategori Surat.pdf', 'I');
?>