...
$pdf->SetTitle('Laporan Surat Disposisi');
$pdf->SetSubject('Laporan Surat Disposisi');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData('assets/img/icons/bartim.jpg', 10, 'Laporan Surat Disposisi', "Alamat: Banyu landas RT. 01, Benua Lima, Kalimantan Tengah", array(0,0,0), array(0,0,0));
...
$pdf->Output( 'Laporan Surat Disposisi.pdf', 'I');
?>
