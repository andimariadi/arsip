...
$pdf->SetHeaderData(base_url('assets/img/icons/bartim.jpg'), 10, 'Laporan Surat Keluar', "Alamat: Banyu landas RT. 01, Benua Lima, Kalimantan Tengah\n{$tanggal}", array(0,0,0), array(0,0,0));
