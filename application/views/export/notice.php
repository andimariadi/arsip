...
$pdf->SetTitle('Laporan Pengunguman');
$pdf->SetSubject('Laporan Pengunguman');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData('assets/img/icons/bartim.jpg', 10, 'Laporan Pengunguman', "Alamat: Banyu landas RT. 01, Benua Lima, Kalimantan Tengah", array(0,0,0), array(0,0,0));
...
$pdf->Output( 'Laporan Pengunguman.pdf', 'I');
?>
