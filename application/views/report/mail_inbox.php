              ...
              <form method="GET">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4" style="margin-bottom:0">
                    ...
                    <?= permission_export('<a class="btn btn-outline-primary" href="'.base_url('export/report_mail_inbox/?start_date='.$start_date.'&end_date='.$end_date).'"><span class="ni ni-send"></span> Export</a>');?>
                  </div>
                </div>
