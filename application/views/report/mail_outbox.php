              ...
              <form method="GET">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4" style="margin-bottom:0">
                    ...
                    <?= permission_export('<a class="btn btn-outline-primary" href="'.base_url('export/report_mail_outbox/?start_date='.$start_date.'&end_date='.$end_date).'"><span class="ni ni-send"></span> Export</a>');?>
                  </div>
                </div>
    ...
    <div class="col">
      <div class="card">
        ...
        <?php $this->template->pagging(
          array(
            'page_total' => $page_total, 'page' => $page, 'url' => base_url('report/mail_outbox/?start_date='.$start_date.'&end_date='.$end_date.'&page=')
          )
        );?>
      </div>
    </div>
